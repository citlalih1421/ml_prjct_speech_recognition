...
def summarizing_func(file_path, max_length=130, min_length=30, size_to_read=1800):
    ...
    with open(file_path, 'r') as f, open('summary.txt', 'w') as s:
        ...
        while len(section_content) > 0:
            ...
            #Call summarizer
            summary_list = summarizer(section_content, max_length=max_length, min_length=min_length, do_sample=False)
